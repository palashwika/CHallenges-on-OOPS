...
class FruitQuiz:
    ...
    def __init__(self):
        ...
        #creat a dictionary of fruits as keys and color as value
    ...
    def quiz(self):
        while(True):
            fruit,color=random.choice(list(self.fruits.items())) #typecasting into list allows access for keys ONLY
